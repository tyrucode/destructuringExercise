...
console.log(`Your coordinates are x: ${xCoords} and y: ${yCoords}`);
...
doorCode.middle = remaining.third;
...
function revealPath({ direction, distance }) {
	console.log(`You will need to go ${direction} this distance ${distance}`)
};
